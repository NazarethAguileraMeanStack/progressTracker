...
core1.addTask('Messer - 1.5 - Mobile Device Accessories', 9, false);
core1.addTask('Messer - 1.6 - Mobile Device Connectivity', 13, false);
core1.addTask('Messer - Configuring Email on Mobile Devices', 12, false);
core1.addTask('Messer - 1.7 - Mobile Device Synchronization', 9, false);
core1.addTask('Messer - 2.1 - Introduction to IP', 21, false);
core1.addTask('Messer - 2.1 - Common Network Ports', 17, false);
core1.addTask('Messer - 2.2 - Network Devices', 30, false);
core1.addTask('Messer - 2.3 - Installing a SOHO Network', 10, false);
core1.addTask('Messer - 2.3 - Configuring a SOHO Firewall', 17, false);
core1.addTask('Messer - 2.4 - 802.11 Wiresless Standards', 10, false);
core1.addTask('Messer - 2.4 - Wireless Network Technologies', 13, false);
core1.addTask('Messer - 2.4 - Cellular Network Technologies', 4, false);
core1.addTask('Messer - 2.5 - Network Services', 19 , false);
core1.addTask('Messer - 2.6 - An Overview of IPv4 and IPv6', 10, false);
core1.addTask('Messer - 2.6 - Assigning IP Addresses', 13, false);
core1.addTask('Messer - 2.6 - Using IP Addresses', 11, false);
core1.addTask('Messer - 2.7 - Internet Connection Types', 16, false);
core1.addTask('Messer - 2.7 - Network Types', 8, false);
core1.addTask('Messer - 2.8 - Network Tools', 19, false);
core1.addTask('Messer - 3.1 - Copper Network Cables', 22, false);
core1.addTask('Messer - 3.1 - Fiber Network Cables', 6, false);
core1.addTask('Messer - 3.1 - Video Cables', 11, false);
core1.addTask('Messer - 3.1 - Multipurpose Cables', 12, false);
core1.addTask('Messer - 3.1 - SATA Drive Cables', 4, false);
core1.addTask('Messer - 3.1 - PATA Drive Cables', 7, false);
core1.addTask('Messer - 3.1 - SCSI Drive Cables', 11, false);
core1.addTask('Messer - 3.1 - Adapters and Converters', 5, false);
core1.addTask('Messer - 3.2 - Connectors', 15, false);
core1.addTask('Messer - 3.3 - Overview of Memory', 14, false);
core1.addTask('Messer - 3.3 - Memory Technologies', 10, false);
core1.addTask('Messer - 3.4 - Storage Devices', 16, false);
core1.addTask('Messer - 3.4 - RAID', 13, false);
core1.addTask('Messer - 3.5 - Motherboard from Form Factors', 12, false);
core1.addTask('Messer - 3.5 - Motherboard Expansion Slots', 20, false);
core1.addTask('Messer - 3.5 - Motherboard Connectors', 11, false);
core1.addTask('Messer - 3.5 - BIOS', 9, false);
core1.addTask('Messer - 3.5 - BIOS Options', 13, false);
core1.addTask('Messer - 3.5 - BIOS Security', 7, false);
core1.addTask('Messer - 3.5 - Installing BIOS Upgrades', 9, false);
core1.addTask('Messer - 3.5 - CPU Features', 17, false);
core1.addTask('Messer - 3.5 - CPU Cooling', 12, false);
core1.addTask('Messer - 3.5 - Expansion Cards', 8, false);
core1.addTask('Messer - 3.6 - Peripherals', 22, false);
core1.addTask('Messer - 3.7 - Computer Power', 22, false);
core1.addTask('Messer - 3.8 - Custom Computer Systems', 10, false);
core1.addTask('Messer - 3.9 - Common Devices', 10, false);
core1.addTask('Messer - 3.10 - SOHO Multifunction Devices', 18, false);
core1.addTask('Messer - 3.11 - Laser Printers', 17, false);
core1.addTask('Messer - 3.11 - Laser Printer Maintenance', 8, false);
core1.addTask('Messer - 3.11 - Inkjet Printers', 8, false);
core1.addTask('Messer - 3.11 - Inkjet Printer Maintenance', 6, false);
core1.addTask('Messer - 3.11 - Thermal Printers', 5, false);
core1.addTask('Messer - 3.11 - Thermal Printer Maintenance', 4, false);
core1.addTask('Messer - 3.11 - Impact Printers', 8, false);
core1.addTask('Messer - 3.11 - Impact Printer Maintenance', 5, false);
core1.addTask('Messer - 3.11 - Virtual and 3D Printers', 9, false);
core1.addTask('Messer - 4.1 - Cloud Models', 15, false);
core1.addTask('Messer - 4.1 - Cloud Services', 10, false);
core1.addTask('Messer - 4.2 - Client-Side Virtualization', 12, false);
core1.addTask('Messer - 5.1 - How to Troubleshoot', 18, false);
core1.addTask('Messer - Troubleshooting Common Hardware Problems', 32, false);
core1.addTask('Messer - 5.3 - Troubleshooting Hard Drives', 11, false);
core1.addTask('Messer - Troubleshooting Video and Display Issues', 12, false);
core1.addTask('Messer - 5.5 - Troubleshooting Laptops', 13, false);
core1.addTask('Messer - 5.5 - Troubleshooting Mobile Devices', 16, false);
core1.addTask('Messer - Device Disassembly Best Practices', 7, false);
core1.addTask('Messer - Troubleshooting Printers', 17, false);
core1.addTask('Messer - Troubleshooting Networks', 17, false);
